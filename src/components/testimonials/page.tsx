...
const TestimonialsPage = () => {
  return (
    <div className="bg-[#fcf5f2] flex flex-col items-center justify-center my-12 md:my-32 px-4 md:px-8 lg:px-16 py-8 md:py-16 w-full h-[600px]">
      ...
      <p className="text-base md:text-xl text-center max-w-[90%] md:max-w-[850px] mb-6 md:mb-12 text-gray-700 leading-7 md:leading-8 font-normal ">
        ...
        enhance individual beauty. I've never felt more confident in my own
        skin."
      </p>
